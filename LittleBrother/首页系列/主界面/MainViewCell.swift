...
class MainViewCell: UITableViewCell {
    ...
    func fillContents(_ content: Any?) {
        ...
        let url = Router.getAvatarURL(mission.master.id)
        head.imgView.sd_setImage(with: url, placeholderImage: #imageLiteral(resourceName: "headPlaceholder"), options: [.retryFailed, .delayPlaceholder, .cacheMemoryOnly])
